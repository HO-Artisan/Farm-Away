...
public class DrillCarrotBlock extends FACropBlock{
	...
	public static final MapCodec<DrillCarrotBlock> CODEC = simpleCodec(DrillCarrotBlock::new);

	public MapCodec<DrillCarrotBlock> codec() {
		return CODEC;
	}

	public DrillCarrotBlock(Properties properties) {
		super(properties);
	}
	...
	protected ItemLike getBaseSeedId() {
		return FAItems.DRILL_CARROT.get();
	}
