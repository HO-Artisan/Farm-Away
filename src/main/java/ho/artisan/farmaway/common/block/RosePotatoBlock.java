...
public class RosePotatoBlock extends FACropBlock{
	public static final MapCodec<RosePotatoBlock> CODEC = simpleCodec(RosePotatoBlock::new);
	...
	public MapCodec<RosePotatoBlock> codec() {
		return CODEC;
	}

	public RosePotatoBlock(BlockBehaviour.Properties properties) {
		super(properties);
	}

	protected ItemLike getBaseSeedId() {
		return FAItems.ROSE_POTATO.get();
	}
