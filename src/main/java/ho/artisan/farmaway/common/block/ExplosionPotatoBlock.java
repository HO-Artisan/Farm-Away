...
public class ExplosionPotatoBlock extends FACropBlock {
	public static final MapCodec<ExplosionPotatoBlock> CODEC = simpleCodec(ExplosionPotatoBlock::new);
	...
	public MapCodec<ExplosionPotatoBlock> codec() {
		return CODEC;
	}

	public ExplosionPotatoBlock(BlockBehaviour.Properties properties) {
		super(properties);
	}
