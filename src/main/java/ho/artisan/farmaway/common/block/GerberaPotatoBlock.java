...
public class GerberaPotatoBlock extends FACropBlock{
	public static final MapCodec<GerberaPotatoBlock> CODEC = simpleCodec(GerberaPotatoBlock::new);
	...
	public MapCodec<GerberaPotatoBlock> codec() {
		return CODEC;
	}

	public GerberaPotatoBlock(BlockBehaviour.Properties properties) {
		super(properties);
	}
