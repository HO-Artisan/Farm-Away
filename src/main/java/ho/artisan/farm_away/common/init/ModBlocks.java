...
public class ModBlocks {
    ...
    // Farmlands
    public static final Supplier<Block> STONE_FARMLAND = register("name",BlockBehaviour.Properties.of(),BlockFarmland.Type.TERRA);
    public static final Supplier<Block> NETHERRACK_FARMLAND = register("name",BlockBehaviour.Properties.of(),BlockFarmland.Type.FLAME);
    public static final Supplier<Block> END_STONE_FARMLAND = register("name",BlockBehaviour.Properties.of(),BlockFarmland.Type.SHADOW);
    ...
    public static final Supplier<Block> GRANITE_FARMLAND = register("name",BlockBehaviour.Properties.of(),BlockFarmland.Type.SCARLET);
    public static final Supplier<Block> DIORITE_FARMLAND = register("name",BlockBehaviour.Properties.of(),BlockFarmland.Type.RAY);
    public static final Supplier<Block> ANDESITE_FARMLAND = register("name",BlockBehaviour.Properties.of(),BlockFarmland.Type.SHADOW);
