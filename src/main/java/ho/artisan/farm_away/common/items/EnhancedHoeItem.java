...
public class EnhancedHoeItem extends HoeItem {
    protected static final Map<Block, Pair<Predicate<UseOnContext>, Consumer<UseOnContext>>> TILLING_ACTIONS = Maps.newHashMap(
            ImmutableMap.of(
                    Blocks.STONE,
                    Pair.of(HoeItem::onlyIfAirAbove, changeIntoState(ModBlocks.STONE_FARMLAND.get().defaultBlockState())),
                    Blocks.NETHERRACK,
                    Pair.of(HoeItem::onlyIfAirAbove, changeIntoState(ModBlocks.NETHERRACK_FARMLAND.get().defaultBlockState())),
                    Blocks.END_STONE,
                    Pair.of(HoeItem::onlyIfAirAbove, changeIntoState(ModBlocks.END_STONE_FARMLAND.get().defaultBlockState())),
                    Blocks.GRANITE,
                    Pair.of(HoeItem::onlyIfAirAbove, changeIntoState(ModBlocks.GRANITE_FARMLAND.get().defaultBlockState())),
                    Blocks.DIORITE,
                    Pair.of(HoeItem::onlyIfAirAbove, changeIntoState(ModBlocks.DIORITE_FARMLAND.get().defaultBlockState())),
                    Blocks.ANDESITE,
                    Pair.of(HoeItem::onlyIfAirAbove, changeIntoState(ModBlocks.ANDESITE_FARMLAND.get().defaultBlockState()))
            )
    );
